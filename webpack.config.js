...
const entryPoints = ["scripts", "styles", "main", "vendor"];
...
module.exports = {
  ...
  "entry": {
    ...
    "scripts": [
      ...
      "script-loader!./src/assets/js/jquery.scrollex.min.js",
      "script-loader!./src/assets/js/jquery.scrolly.min.js",
      "script-loader!./src/assets/js/skel.min.js",
      "script-loader!./src/assets/js/util.js",
      "script-loader!./src/assets/js/main.js"
    ],
    "styles": [
